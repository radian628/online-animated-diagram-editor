...
export function AddPanelGrid(props: {
  ...
  return (
    <div onMouseLeave={props.onExit} className="add-panel-container">
      <Helpable
        style={{
          gridColumnStart: 2,
          gridColumnEnd: 3,
        ...
        message={
          <p>
            Click to add the new panel above the current one. You can also do
            this with the <kbd>Up Arrow</kbd> key.
          </p>
        }
      >
        <button
      ...
      <Helpable
        ...
        message={
          <p>
            Click to add the new panel to the left of the current one. You can
            also do this with the <kbd>Left Arrow</kbd> key.
          </p>
        }
      >
        <button
      ...
      <Helpable
        ...
        message={
          <p>
            Click to add the new panel to the right of the current one. You can
            also do this with the <kbd>Right Arrow</kbd> key.
          </p>
        }
      >
        <button
      ...
      <Helpable
        message={
          <p>
            Click to add the new panel below the current one. You can also do
            this with the <kbd>Down Arrow</kbd> key.
          </p>
        }
        style={{
          gridColumnStart: 2,
